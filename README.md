...
## Open AI 
Create an OpenAI Account or if you already have one, navigate to Openai.com > API > API Keys > Create New Secret Key. Copy this key, run the script, click "OpenAI" in the toolbar and paste your API Key in the input field. 
