...
If you want to use a packaged version of this script, you can get a download link [here](). Unfortunately, there is only a packaged version for Apple Silicon devices. 
